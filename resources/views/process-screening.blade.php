        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  <h3> Hasil Screening {{  Auth::user()->name }} </h3>
                  <br/>
                    ...
                    <div class="z-10">
                        <div class="w-56 h-64 text-center rounded-lg">
                             <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                                 ...
                                 <form method="POST" class="bg-dark shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
                                     {{ csrf_field() }}
                                 <div class="grid grid-cols-2 gap-4">
                                     <div class="form-group mb-6">
                                        ...
                                        <div type="text" class="form-control
                                            ...
                                            m-0
                                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                            placeholder="KONDISI KESEHATAN" name="kondisi-kesehatan" >
                                 ...
                                 <div class="form-group mb-6">
                                     ...
                                     m-0
                                     focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" 
                                     placeholder="(35 C - 45.5 C)" name="suhu" >
                                     {{ $data->suhu }}
                                    </div>
                                 </div>   
                                 <div class="flex justify-center">
                                     <div class="mb-3 w-96">
                                       ...
                                       <img class="object-fill h-48 w-96" width="200px" src="{{ $data->file }}" alt="file"  />
                                        </div>
                                     </div>
                                 </div>                    
